...
<body class="animsition">
	<div class="page-wrapper">
				...
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <c:if
								test="${phieuPhatIU != null }">
								<img src="../images/icon/logo.png" alt="CoolAdmin" />
							</c:if> <c:if test="${phieuPhatIU == null }">
								<img src="./images/icon/logo.png" alt="CoolAdmin" />
							</c:if>
						</a>
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="#"> <c:if test="${phieuPhatIU != null }">
					...
					<div class="modal-header">
						<c:if test="${phieuPhatIU != null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Sửa phiếu phạt</h3>
						</c:if>
						<c:if test="${phieuPhatIU == null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Thêm phiếu phạt</h3>
						</c:if>
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="section__content section__content--p30">
				...
				<div class="container-fluid">
					<div class="row">
						<form method="post" action="/QuanLyThuVien/PhieuPhatQuanLy"
							...
							<div class="col-12 pull-left">
								...
								<div class="pull-left col-6">
									<p>
										<strong><c:out value="${listPhieuPhat.size() }"></c:out></strong>
										of <strong><c:out value="${total }"></c:out></strong> phiếu
										phạt được tìm thấy
									</p>
								</div>
								<!-- sắp xếp(từ từ tính) -->
