...
<body class="animsition">
	<div class="page-wrapper">
				...
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <c:if
								test="${nhanVienIU != null }">
								<img src="../images/icon/logo.png" alt="CoolAdmin" />
							</c:if> <c:if test="${nhanVienIU == null }">
								<img src="./images/icon/logo.png" alt="CoolAdmin" />
							</c:if>
						</a>
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="#"> <c:if test="${nhanVienIU != null }">
							...
							<div class="form-group col-md-2">
								...
								<c:if test="${nhanVienIU != null }">
									<input type="text" name="txtMaNhanVien" required="required"
										...
										value="${nhanVienIU.getMaNhanVien() }">
								</c:if>
								<c:if test="${nhanVienIU == null }">
									<input type="text" name="txtMaNhanVien" required="required"
	...
	<div class="page-container">
		...
		<div class="main-content">
			<div class="section__content section__content--p30">
				<div class="container-fluid">
					<div class="row">
						<form method="post" action="/QuanLyThuVien/NhanVienQuanLy"
