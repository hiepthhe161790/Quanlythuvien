                        ...
                        <aside>
                            <div class="sigle-sidebar">
                                ...
                                <ul class="list-unstyled menu-tip">
                                    <li><a class="active" href="UserProfile.jsp">Thông tin cá nhân</a></li>
                                    <li><a href="UserChangePassword.jsp">Đổi mật khẩu</a></li>
                                    <li><a href="maCuonSach?maThe=${sessionScope.tkDN.maThe}">Sách của tôi</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xs-12 col-md-10 pull-right">
                        ...
                        <div class="row">
                            <div class="col-md-10 col-xs-12 col-md-offset-1">
                                <form method="post" action="/QuanLyThuVien/updateProfile" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="maTaiKhoan">Mã tài khoản</label>
                                        <input type="text" class="form-control" id="maTaiKhoan" name="maTaiKhoan" 
                                               value="${sessionScope.tkDN.maTaiKhoan}" readonly />
                                    </div>
                                    <div class="form-group">
                                        <label for="maThe">Mã thẻ</label>
                                        <input type="text" class="form-control" id="maThe" name="maThe" 
                                               value="${sessionScope.tkDN.maThe}" readonly />
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="${sessionScope.tkDN.eMail}" required readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="phone">Số điện thoại</label>
                                        <input type="text" class="form-control" id="phone" name="phone" 
                                               value="${sessionScope.tkDN.soDienThoai}" required readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label>Ảnh đại diện</label>
                                        <input type="file" name="avatar" class="form-control" accept="image/*" />
                                        <c:if test="${not empty sessionScope.tkDN.getMaTaiKhoan()}">
                                            <img src="http://localhost:9999/QuanLyThuVien/getAvartar?maTaiKhoan=${tkDN.getMaTaiKhoan() }" 
