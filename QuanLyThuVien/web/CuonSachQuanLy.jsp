...
<body class="animsition">
	<div class="page-wrapper">
				...
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <c:if
								test="${cuonSachIU != null }">
								<img src="../images/icon/logo.png" alt="CoolAdmin" />
							</c:if> <c:if test="${cuonSachIU == null }">
								<img src="./images/icon/logo.png" alt="CoolAdmin" />
							</c:if>
						</a>
		...
		<aside class="menu-sidebar d-none d-lg-block">
			<div class="logo">
				<a href="#"> <c:if test="${cuonSachIU != null }">
					...
					<ul class="list-unstyled navbar__list">
						...
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="list-unstyled navbar__sub-list js-sub-list">
								...
								<li><a href="cuonSach.html">Đọc giả</a></li>
								<li><a href="thongbao.html">Thông báo</a></li>
								<li><a href="cuonSach.html">Đầu sách</a></li>
					...
					<div class="modal-header">
						<c:if test="${cuonSachIU != null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Sửa Cuốn Sách</h3>
						</c:if>
						<c:if test="${cuonSachIU == null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Thêm Cuốn Sách</h3>
						</c:if>
							...
							<div class="form-group col-md-12">
								...
								<c:if test="${cuonSachIU != null }">
									<input type="text" name="txtMaCuonSach" required="required"
										...
										value="${cuonSachIU.getMaCuonSach() }">
								</c:if>
								<c:if test="${cuonSachIU == null }">
									<input type="text" name="txtMaCuonSach" required="required"
	...
	<div class="page-container">
		...
		<div class="main-content">
			<div class="section__content section__content--p30">
				<div class="container-fluid">
					<div class="row">
						<form method="post" action="/QuanLyThuVien/CuonSachQuanLy"
							...
							<div class="col-12 pull-left">
								...
								<div class="input-group">
									<input type="text" class="form-control" id="txtSearch"
										name="txtSearch" placeholder="Nhập tên Cuốn Sách,..."
											...
											<div class="shop-pagination pull-right">
												<ul id="" class="pagination-sm pagination">
													<li class="page-item first"><a
														href="/QuanLyThuVien/CuonSachQuanLy?pages=1"
