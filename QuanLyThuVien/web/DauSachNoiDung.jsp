    ...
    <body data-spy="scroll" data-target="#mainmenu" data-offset="50">
                        ...
                        <div class="row">
                            <div class="book-details-item">
                                ...
                                <div class="media-left">
                                    <img
                                        src="http://localhost:9999/QuanLyThuVien/getAnhBia?maDauSach=${dauSachDetail.getMaDauSach() }"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-8">
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <img
                                                    src="http://localhost:9999/QuanLyThuVien/getAnhTacGia?maDauSach=${dauSachDetail.getMaDauSach() }"
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <h4>Số Tiền</h4>
                                        <p>
                                    <c:out value="${dauSachDetail.getGia()} đồng" />
                                </p>
                                    </div>
                                </div>
                                <div class="space-30"></div>
                                ...
                                <div class="space-20"></div>
                                <a
                                    href="http://localhost:9999/QuanLyThuVien/getFilePDF?maDauSach=${dauSachDetail.getMaDauSach() }"
                                    class="btn btn-primary hover-btn-default">Download</a>
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#InsertUpdate">
                                    Thêm Mượn Trả Sách Chi Tiết
                                </button>
                                <div class="space-20"></div>
                                <embed
                                    src="http://localhost:9999/QuanLyThuVien/getFilePDF?maDauSach=${dauSachDetail.getMaDauSach() }"
                        ...
                        <div class="modal-lg modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title" id="InsertLabel" style="font-family: 'Roboto';">Thêm Mượn Trả Sách</h3>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <!-- Gộp Form Mượn Trả Sách và Mượn Trả Sách Chi Tiết -->
                                    <form method="post" action="/QuanLyThuVien/MuonTraSachQuanLy/add" id="formMuonTraSach">
                                        <div class="row">
                                            <!-- Form 1: Mượn Trả Sách -->
                                            <div class="form-group col-md-4">
                                                <label>Mã Mượn Sách</label>
                                                <input type="text" name="txtMaMuonSach" required="required" class="form-control" value="${maxCodeMuonTraSach + 1}" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Mã Thẻ</label>
                                                <input type="text" name="txtMaThe" required="required" value="${sessionScope.tkDN.maThe}" class="form-control" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Tiền Đặt Cọc</label>
                                                <input type="number" name="numberTienDatCoc" class="form-control" step="1000" required="required" min="1000">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <label>Ghi Chú</label>
                                                <textarea rows="5" id="txtGhiChu" name="txtGhiChu" class="col-md-12 form-control" style="border: solid 1px green;"></textarea>
                                            </div>
                                        </div>

                                        <!-- Form 2: Mượn Trả Sách Chi Tiết -->
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label>Mã Cuốn Sách</label>
                                                <input type="text" name="txtMaCuonSach" required="required" class="form-control" value="${maCuonSach}" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Ngày Mượn</label>
                                                <input type="date" name="dateNgayMuon" class="form-control" required="required">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label>Ngày Hẹn Trả</label>
                                                <input type="date" name="dateNgayHenTra" class="form-control" required="required">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label>Ngày Trả</label>
                                                <input type="date" name="dateNgayTra" class="form-control">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label>Số Lượng</label>
                                                <input type="number" name="numberSoLuong" class="form-control" step="1" value="1" required="required" min="1">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label>Trạng Thái</label>
                                                <input type="text" name="txtTrangThai" id="txtTrangThai" class="form-control" value="Xử Lý" readonly>
                                            </div>
                                        </div>
                                    </form>
                                </div>

                                <!-- Nút Submit Cả Hai Form -->
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                                    <button class="btn btn-primary" type="submit" form="formMuonTraSach">Thêm</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            function submitBothForms() {
                ...
                let formMuonTraSach = document.getElementById("formMuonTraSach");
                let formMuonTraSachChiTiet = document.getElementById("formMuonTraSachChiTiet");


                formMuonTraSach.submit();


                setTimeout(() => {
                    formMuonTraSachChiTiet.submit();
                }, 3000);
            }
        </script>
